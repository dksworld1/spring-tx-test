...
public class MybatisH2TestServiceTest {
	
	public static void main(String[] args) {
		System.out.println("*** App start ***");
		MybatisH2TestService svc = (MybatisH2TestService) AppContextHolder.getApplicationContext().getBean("mybatisH2TestService");
